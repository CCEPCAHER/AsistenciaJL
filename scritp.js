const people = [
  { id: 2,  name: "Aradilla, Lola", absenceHistory: [] },
  { id: 3,  name: "Correa, Alejandro", absenceHistory: [] },
  { id: 4,  name: "Hosu, Débora de", absenceHistory: [] },
  { id: 5,  name: "Hosu, Samuel", absenceHistory: [] },
  { id: 6,  name: "Ligero, Remedios", absenceHistory: [] },
  { id: 7,  name: "Ondina, Olga", absenceHistory: [] },
  { id: 8,  name: "Mayra López Menjivar", absenceHistory: [] },
  { id: 9,  name: "Martinez, Andy", absenceHistory: [] },
  { id: 10, name: "Mercader, Mª Ángeles", absenceHistory: [] },
  { id: 11, name: "Miranda, Segundo", absenceHistory: [] },
  { id: 12, name: "Montaño, María", absenceHistory: [] },
  { id: 13, name: "Pérez, Remedios", absenceHistory: [] },
  { id: 14, name: "Quintero, Mirelia", absenceHistory: [] },
  { id: 15, name: "Rondón, Yosnery", absenceHistory: [] },
  { id: 16, name: "Sacramento, Giovana", absenceHistory: [] },
  { id: 17, name: "Sánchez, Carmen de", absenceHistory: [] },
  { id: 18, name: "Sánchez, Francisco", absenceHistory: [] },
  { id: 19, name: "Torres, Juan Luis", absenceHistory: [] },
  { id: 20, name: "Torres, Mercedes de", absenceHistory: [] }
];
